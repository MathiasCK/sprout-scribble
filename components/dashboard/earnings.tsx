...
import { monthlyChart, weeklyChart } from "~/lib/charts";

const Earnings = ({ totalOrders }: { totalOrders: Order[] }) => {
                ...
                content={props => (
                  <div>
                    {props.payload?.map(item => {
                      return (
                        <div
                          className="rounded-md bg-primary px-4 py-2 text-white shadow-lg"
